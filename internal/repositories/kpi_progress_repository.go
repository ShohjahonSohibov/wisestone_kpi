...
func (r *KPIProgressRepository) EmployeeProgress(ctx context.Context, req *models.KPIProgressEmployeeFilter) (*models.ListKPIProgressResponse, error) {
	pipeline := []bson.M{
		{
			"$match": bson.M{
